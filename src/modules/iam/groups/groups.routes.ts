...
import { createGroupSchema, updateGroupSchema, addMemberSchema, groupQuerySchema, attachPolicySchema, idParamSchema, groupUserParamSchema, groupPolicyParamSchema } from './groups.validation';
...
groupRoutes.get('/delegatable', iamCheck(['iam:ListGroups', 'iam:AddUserToGroup']), validate(groupQuerySchema, 'query'), asyncHandler(groupController.listDelegatableGroups));
