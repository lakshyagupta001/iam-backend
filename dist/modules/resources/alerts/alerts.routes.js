...
exports.alertsRoutes.get('/', (0, iam_middleware_1.iamCheck)('alerts:List'), (0, express_async_handler_1.default)(alerts_controller_1.alertsController.list));
...
exports.alertsRoutes.patch('/:id/acknowledge', (0, iam_middleware_1.iamCheck)('alerts:Acknowledge'), (0, express_async_handler_1.default)(alerts_controller_1.alertsController.acknowledge));
